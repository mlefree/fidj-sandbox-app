  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
    ...
    function ncJE(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProfilePage = /*#__PURE__*/function () {
        function ProfilePage(router, fidjService) {
        ...
        _createClass(ProfilePage, [{
          ...
          value: function refresh(event) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var idToken, payload, payloadInfo;
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.prev = 0;
                      _context.next = 3;
                      return this.fidjService.getIdToken();

                    case 3:
                      idToken = _context.sent;
                      payload = idToken.split('.')[1];
                      payloadInfo = JSON.parse(fidj__WEBPACK_IMPORTED_MODULE_5__["Base64"].decode(payload));
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      _context2.next = 2;
                      return this.fidjService.logout();
